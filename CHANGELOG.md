...
- Channels: send a user-facing error reply when an unrecoverable handler error occurs (e.g. disk full) instead of silently dropping the message. Applies to Telegram, Discord, and WhatsApp handlers.
